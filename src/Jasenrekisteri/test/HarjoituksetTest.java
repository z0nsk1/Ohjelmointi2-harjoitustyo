 ...
 * @version 2020.04.29 19:01:10 // Generated by ComTest
 *
 */
...
public class HarjoituksetTest {
  ...
  public void test_tiedosto() throws SailoException {    // Harjoitukset: 40
    ...
    fail("Harjoitukset: 51 Did not throw SailoException");
    ...
    assertEquals("From: Harjoitukset line: 61", harj1.toString(), i.next().toString()); 
    assertEquals("From: Harjoitukset line: 62", harj2.toString(), i.next().toString()); 
    assertEquals("From: Harjoitukset line: 63", harj3.toString(), i.next().toString()); 
    assertEquals("From: Harjoitukset line: 64", harj4.toString(), i.next().toString()); 
    assertEquals("From: Harjoitukset line: 65", harj5.toString(), i.next().toString()); 
    assertEquals("From: Harjoitukset line: 66", false, i.hasNext()); 
    harjoitukset.lisaa(harj5); 
    harjoitukset.tallenna(); 
    ftied.delete(); 
