 ...
 * @version 2020.04.30 01:59:42 // Generated by ComTest
 *
 */
...
public class JasenTest {
  ...
  public void test_parse() {    // Jasen: 25
    ...
    assertEquals("From: Jasen line: 30", true, jasen.toString().startsWith("2|Erkki Esimerkki|2020|"));  // on enemmäkin kuin 3 kenttää, siksi loppu |
    jasen.rekisteroi(); 
